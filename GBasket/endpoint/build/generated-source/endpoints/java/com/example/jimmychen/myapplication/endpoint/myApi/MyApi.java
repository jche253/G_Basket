...
<<<<<<< HEAD
 * on 2016-04-06 at 02:55:17 UTC 
=======
 * on 2016-04-05 at 23:37:39 UTC 
>>>>>>> 4ff67cf7f2389db82c1f7623d218c015794e2232
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public Adduser adduser(java.lang.String email, java.lang.String pw) throws java.io.IOException {
    Adduser result = new Adduser(email, pw);
    initialize(result);
    return result;
  }

  public class Adduser extends MyApiRequest<com.example.jimmychen.myapplication.endpoint.myApi.model.MyBean> {

    private static final String REST_PATH = "adduser/{email}/{pw}";
     ...
     * @since 1.13
     */
    protected Adduser(java.lang.String email, java.lang.String pw) {
    ...
    public Adduser setPw(java.lang.String pw) {
      this.pw = pw;
      return this;
    }
