 ...
 * on 2016-03-28 at 19:20:50 UTC 
 * Modify at your own risk.
 */

package com.example.jimmychen.myapplication.endpoint.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class SayHi extends MyApiRequest<com.example.jimmychen.myapplication.endpoint.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.jimmychen.myapplication.endpoint.myApi.model.MyBean.class);
  ...
  /**
   * Create a request for the method "tet".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link Tet#execute()} method to invoke the remote operation.
   *
   * @param name
   * @return the request
   */
  public Tet tet(java.lang.String name) throws java.io.IOException {
    Tet result = new Tet(name);
    initialize(result);
    return result;
  }

  public class Tet extends MyApiRequest<com.example.jimmychen.myapplication.endpoint.myApi.model.MyBean> {

    private static final String REST_PATH = "test/{name}";

    /**
     * Create a request for the method "tet".
     *
     * This request holds the parameters needed by the the myApi server.  After setting any optional
     * parameters, call the {@link Tet#execute()} method to invoke the remote operation. <p> {@link
     * Tet#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)} must be
     * called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @param name
     * @since 1.13
     */
    protected Tet(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.jimmychen.myapplication.endpoint.myApi.model.MyBean.class);
      this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
    }

    @Override
    public Tet setAlt(java.lang.String alt) {
      return (Tet) super.setAlt(alt);
    }

    @Override
    public Tet setFields(java.lang.String fields) {
      return (Tet) super.setFields(fields);
    }

    @Override
    public Tet setKey(java.lang.String key) {
      return (Tet) super.setKey(key);
    }

    @Override
    public Tet setOauthToken(java.lang.String oauthToken) {
      return (Tet) super.setOauthToken(oauthToken);
    }

    @Override
    public Tet setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (Tet) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public Tet setQuotaUser(java.lang.String quotaUser) {
      return (Tet) super.setQuotaUser(quotaUser);
    }

    @Override
    public Tet setUserIp(java.lang.String userIp) {
      return (Tet) super.setUserIp(userIp);
    }
    ...
    public Tet setName(java.lang.String name) {
      this.name = name;
      return this;
    }

    @Override
    public Tet set(String parameterName, Object value) {
      return (Tet) super.set(parameterName, value);
    }
  }
